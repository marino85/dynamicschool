    ...
    public Converter getTipoDocConverter(){
        return new Converter() {
            ...
            public Object getAsObject(FacesContext context, UIComponent component, String value) {
                ...
                List<IappTipoDocumento> tiposDoc=gb.getTiposDoc();
                for(IappTipoDocumento td:tiposDoc){
    ...
    public Converter getEstudiantesConverter(){
        return new Converter() {
            ...
            public Object getAsObject(FacesContext context, UIComponent component, String value) {
                ...
                List<IappUsuario> usuario=gb.getEstudiantesList();
                for(IappUsuario us:usuario){
    ...
    public Converter getUsuariosConverter(){
        return new Converter() {
            ...
            public Object getAsObject(FacesContext context, UIComponent component, String value) {
                ...
                List<IappUsuario> usuarios=gb.getUsuarios();
                for(IappUsuario usr:usuarios){
    ...
    public Converter getCursosConverter(){
        return new Converter() {
            ...
            public Object getAsObject(FacesContext context, UIComponent component, String value) {
                ...
                List<IappCursos> cursos=gb.getCursos();
                for(IappCursos crs:cursos){
