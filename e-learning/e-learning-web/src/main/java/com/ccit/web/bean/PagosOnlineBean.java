...
public class PagosOnlineBean implements Serializable {
    ...
    private IappCursos courseSelected;
    ...
    public void init() {
        ...
        this.courseSelected = new IappCursos();
    }
    ...
    public IappCursos getCourseSelected() {
        return courseSelected;
    }

    public void setCourseSelected(IappCursos courseSelected) {
