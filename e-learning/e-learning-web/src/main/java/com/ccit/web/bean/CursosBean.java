...
//    private IappCourses newCourse;
//    private IappCourses editCourse;
//    private IappUser estudiante;    
//    private ArrayList<IappUser> estudiantesSelected = new ArrayList<IappUser>();
...
//    public List<IappUser> estudiantesNocurso = new ArrayList<IappUser>();
//    
...
//            for (IappSprints mod : editCourse.getIappModulosCollection()) {
...
//        editCourse = new IappCourses();
//        editCourse.setIdEstadoCurso(new IappEstadosCurso());
//        editCourse.setIdProfesor(new IappUser());
//        editCourse.setIappMatriculasCollection(new ArrayList<IappEnrollments>());
//        editCourse.setIappModulosCollection(new ArrayList<IappSprints>());
//        return "editarCurso";
//    }
//
...
//    }
//
//    public void adicionarEstudiante(IappUser user) {
//        if (user != null) {
...
//        UsuarioDTo u = (UsuarioDTo) WebUtil.getObjectFromSession("userLogged");
//        for (IappUser est : estudiantesSelected) {
//            IappEnrollments matricula = new IappEnrollments();
...
//    }
//    
//    public void eliminarMatricula(IappEnrollments matricula){
//        try {
...
//    }
//
//    public IappCourses getNewCourse() {
//        return newCourse;
//    }
//
//    public void setNewCourse(IappCourses newCourse) {
...
//    }
//
//    public ArrayList<IappUser> getEstudiantesSelected() {
//        return estudiantesSelected;
//    }
//
//    public void setEstudiantesSelected(ArrayList<IappUser> estudiantesSelected) {
...
//    }
//
//    public List<IappUser> getEstudiantesNocurso() {
//        return estudiantesNocurso;
//    }
//
//    public void setEstudiantesNocurso(List<IappUser> estudiantesNocurso) {
